...
THREE.VREffect = function ( renderer, done ) {
		...
		function gotVRDevices( devices ) {
			...
			for ( var i = 0; i < devices.length; ++i ) {
				if ( devices[i] instanceof HMDVRDevice ) {
					...
					self.leftEyeTranslation = leftEyeParams.eyeTranslation;//vrHMD.getEyeTranslation( "left" );
					self.rightEyeTranslation = rightEyeParams.eyeTranslation;//vrHMD.getEyeTranslation( "right" );
					self.leftEyeFOV = leftEyeParams.recommendedFieldOfView;//vrHMD.getRecommendedEyeFieldOfView( "left" );
					self.rightEyeFOV = rightEyeParams.recommendedFieldOfView;//vrHMD.getRecommendedEyeFieldOfView( "right" );
	...
	this.zoom = function ( v ) {
		this.leftEyeFOV.upDegrees += v;
		this.leftEyeFOV.downDegrees += v;
		this.leftEyeFOV.leftDegrees += v;
		this.leftEyeFOV.rightDegrees += v;
		this.rightEyeFOV.upDegrees += v;
		this.rightEyeFOV.downDegrees += v;
		this.rightEyeFOV.leftDegrees += v;
		this.rightEyeFOV.rightDegrees += v;
	}
