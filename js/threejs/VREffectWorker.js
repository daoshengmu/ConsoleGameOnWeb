...
// VREffect customized version in order to solve some worker special cases (dom, vrHMD can't access)
THREE.VREffectWorker = function ( renderer, onError ) {
	...
	this.zoom = function ( v ) {
		...
		eyeFOVL.upDegrees += v;
		eyeFOVL.downDegrees += v;
		eyeFOVL.leftDegrees += v;
		eyeFOVL.rightDegrees += v;
		eyeFOVR.upDegrees += v;
		eyeFOVR.downDegrees += v;
		eyeFOVR.leftDegrees += v;
		eyeFOVR.rightDegrees += v;
